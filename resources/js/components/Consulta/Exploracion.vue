<script setup>
    ...
    import PielFanerasTejido from "@/pages/Consulta/PielFanerasTejido.vue";
    import Cabeza from "@/pages/Consulta/Cabeza.vue";
    import Oftalmologico from "@/pages/Consulta/Oftalmologico.vue";
    import Respiratorio from "@/pages/Consulta/Respiratorio.vue";
    import Cardiovascular from "@/pages/Consulta/Cadiovascular.vue";
    import Abdomen from "@/pages/Consulta/Abdomen.vue";
    import Neurologico from "@/pages/Consulta/Neurologico.vue";
    import GinecoObstetrico from "@/pages/Consulta/GinecoObstetrico.vue";    
    import { watch } from "vue";
    import { router, Head, usePage } from '@inertiajs/vue3';
    import Alerta from '../AppAlerta.vue';
    const api = "/consulta/";
// export default {
//     components: {
//         PielFanerasTejido,
