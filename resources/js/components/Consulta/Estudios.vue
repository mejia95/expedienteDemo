<script setup type="text/javascript">
	...
	import Laboratorio from '@/pages/Consulta/Laboratorio.vue';
	import Electrocardiograma from '@/pages/Consulta/Electrocardiograma.vue';
	import RadiografiaTorax from '@/pages/Consulta/RadiografiaTorax.vue';
	...
	const api = "/consulta/";
			...
			const setValoresLaboratorio = (DatosLaboratorio)=>{
				...
				if(('archivoLab1' in DatosLaboratorio[0]) && DatosLaboratorio[0].archivoLab1){
					...
					Laboratorio.value.archivoLab1 = newFile;
					Laboratorio.value.archivoDatos.type=DatosLaboratorio[0].archivoLab1.tipo_archivo;
					Laboratorio.value.archivoDatos.base64=DatosLaboratorio[0].archivoLab1.base64_archivo;
					Laboratorio.value.NombreArchivo = DatosLaboratorio[0].archivoLab1.nombre_archivo;
