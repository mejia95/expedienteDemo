<script setup >
    ...
    const ObtenerPacientes = async ()=>{
        await goTo(0,{});
        const url = `${api}/lista/mis-pacientes`;        
    ...
    <App :breadcrumbs="breadcrumbs">
        <v-container fluid>
            <v-row class="my-4 mx-5" no-gutters>
                <v-col cols="12">
                    <span class="poppins-semibold seccion-titulo">{{$page.props.session.Dependencia}} - PACIENTES</span>
                </v-col>
                <v-col cols="12">
                    <div class="poppins-light text-grey-darken-1">
                        Gestión de pacientes en: agregar nuevos pacientes, consulta la información y actualización de datos.
                    </div>
                </v-col>
