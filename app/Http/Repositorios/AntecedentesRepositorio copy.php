...
class AntecedentesRepositorio 
{
    ...
    public function Agregar($request){
        ...
        if ($validator->fails()) {
            ...
            //      $message="<p>Asegúrese de no haber ingresado caracteres especiales en Antecedentes personales patológicos </p>";
            // }
            ...
            //      $message="<p>Asegúrese de no haber ingresado caracteres especiales en Toxicomanías</p>";
            // }
        ...
        $consulta = Antecedentes::create([
            //'id_consulta' => new \MongoDB\BSON\ObjectId($id_consulta) ,
            'pacienteId' => new \MongoDB\BSON\ObjectId($id_consulta) ,
        ...
        if($consulta){
            ...
            // return response()->json(['msg'=>"Se ha guardado correctamente la información",'consulta'=>$consulta]);   
            //return $consulta;
        }else{
    ...
    public function Actualizar($id_consulta, $request){
        ...
        try{
            ...
            //$antecedentes = Antecedentes::findOrFail(new ObjectId($consulta->_id));
            ...
            if($antecedentes){
                ...
                $request->merge(['id_consulta'=>$id_consulta]);
